...
page_list = driver.find_elements_by_class_name('a-disabled')
pages = int(page_list[-1].text)
...
def getdata(driver,pages):
    ...
    while current<pages:
        all_divs = soup.findAll('div', attrs={'class':'sg-col-4-of-12 sg-col-8-of-16 sg-col-16-of-24 sg-col-12-of-20 sg-col-24-of-32 sg-col sg-col-28-of-36 sg-col-20-of-28'})
